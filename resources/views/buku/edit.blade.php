...
<aside id="left-sidebar-nav">
         ...
         <form class="form-horizontal" role="form" method="POST" action="/buku/{{$siswas->isbn}}">
          {{ csrf_field() }}
         <div class="row">
        <div class="input-field col s12">
        <div class="form-group{{ $errors->has('isbn') ? ' has-error' : '' }}">
          <i class="material-icons prefix">vpn_key</i>
          <input id="icon_prefix isbn" type="number" class="validate form-control" name="isbn" value="{{$siswas->isbn}}" required autofocus>
        ...
        <input id="icon_prefix judul" type="text" class="validate form-control" name="judul" value="{{$siswas->judul}}" required>
        ...
        <div class="form-group{{ $errors->has('pengarang') ? ' has-error' : '' }}">
          ...
          <input id="pengarang" type="text" class="validate form-control" name="pengarang" required value="{{$siswas->pengarang}}">
